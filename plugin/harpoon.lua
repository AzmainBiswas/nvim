...
vim.keymap.set("n", "<M-n>", function() require("harpoon.ui").nav_next() end, { desc = "harpoon next" })
vim.keymap.set("n", "<M-p>", function() require("harpoon.ui").nav_prev() end, { desc = "harpoon prev" })
vim.keymap.set("n", "<M-1>", function() require("harpoon.ui").nav_file(1)  end, { desc = "harpoon nav" })
vim.keymap.set("n", "<M-2>", function() require("harpoon.ui").nav_file(2)  end, { desc = "harpoon nav" })
vim.keymap.set("n", "<M-3>", function() require("harpoon.ui").nav_file(3)  end, { desc = "harpoon nav" })
vim.keymap.set("n", "<M-4>", function() require("harpoon.ui").nav_file(4)  end, { desc = "harpoon nav" })
vim.keymap.set("n", "<M-5>", function() require("harpoon.ui").nav_file(5)  end, { desc = "harpoon nav" })
vim.keymap.set("n", "<M-6>", function() require("harpoon.ui").nav_file(6)  end, { desc = "harpoon nav" })
