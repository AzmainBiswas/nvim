...
vim.api.nvim_create_user_command("Hq", function() require("harpoon.ui").toggle_quick_menu() end,
...
vim.api.nvim_create_user_command("Ht", function() require("harpoon.term").gotoTerminal(1)  end, { desc = "harpoon prev" })
...
vim.keymap.set("n", "<leader>ht", function() require("harpoon.term").gotoTerminal(1)  end, { desc = "harpoon prev" })
